...
namespace OLO_CAN
{
	partial class AboutBox : Form
	{
        ...
        public String comment =
                        "v.1.6.13.365" + "\r\n" +
                        " - Найдена и исправлена мелкая ошибка в OLO_EMU." + "\r\n" +
                        " - Опять перестал работать фейковый драйвер. ХЗ почему." + "\r\n" +
                        "v.1.6.13.361" + "\r\n" +
                        " - В симуляторе добавлен режим сценариев. Пока ввод данных только в ПСК ОЛО." + "\r\n" +
                        " - Прикручена библиотека от Харченко с функциями пересчета ПСК в ССК и обратно." + "\r\n" +
                        " - В юстировке и техно прием добавлено автоматическое сохранение картинок в сыром виде." + "\r\n" +
                        "v.1.6.10.341" + "\r\n" +
                        " - Переделан сильно Техно прием. Теперь автоматически принимаются две картинки." + "\r\n" +
                        " - Техно прием работает с пакетами 8 байт и 6 байт." + "\r\n" +
                        "v.1.6.9.336" + "\r\n" +
                        " - Добавлена вкладка симуляции технологической прошивки." + "\r\n" +
                        "v.1.6.8.330" + "\r\n" +
                        " - Добавлен вывод углов в ССК сомолетов для симулятора ОЛО." + "\r\n" +
                        "v.1.6.7.329" + "\r\n" +
                        " - Найдены и исправлены ошибки в OLO_SET." + "\r\n" +
                        " - Добавлена вкладка для работы с технологической прошивкой TECH_SELECT_V3." + "\r\n" +
                        "v.1.6.6.325" + "\r\n" +
                        " - Найдены и исправлены две серьезные ошибки в OLO_SET." + "\r\n" +
                        "v.1.6.5.321" + "\r\n" +
                        " - Найдено и исправлено несколько мелких ошибок в эмуляторе и не только." + "\r\n" +
                        "v.1.6.5.320" + "\r\n" +
                        " - Переделан сильно OLO_test." + "\r\n" +
                        " - Переделан сильно OLO_emu." + "\r\n" +
                        "v.1.6.4.312" + "\r\n" +
                        " - Переделан OLO_test." + "\r\n" +
                        " - Переделан OLO_emu." + "\r\n" +
                        " - В OLO-emu добавлены автоматические выстрелы отдельные для правого и левого ОЛО." + "\r\n" +
                        "v.1.6.3.301" + "\r\n" +
